...
var apiKeyRoutes = []apiKeyRoute{
	...
	{method: http.MethodGet, re: regexp.MustCompile(`^/api/v1/templates/([^/]+)/render-overlay\.png$`), scope: apikeys.ScopeExport, designIdx: -1, label: "http:render_template_overlay_png"},
