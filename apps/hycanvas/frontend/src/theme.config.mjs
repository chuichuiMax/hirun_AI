...
export const theme = {
  ...
  // Primary brand accent. In ContentSwarm managed mode this follows the host
  // product's teal palette so the embedded workspace reads as one surface.
  brand: {
    50: "#E1F6FB",
    100: "#C4EAF5",
    200: "#A3D8E8",
  ...
  // Secondary accent stays in the same cool family as ContentSwarm.
  accent: {
    50: "#ECFEFF",
    100: "#CFFAFE",
    200: "#A5F3FC",
