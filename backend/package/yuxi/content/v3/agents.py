...
CONTENT_AGENT_SPECS = (
    ...
    ContentAgentSpec(
        ...
        skills=("content-evidence-researcher",),
    ...
    ContentAgentSpec(
        ...
        skill_tools=("get_business_facts",),
    ),
    ContentAgentSpec(
        ...
        skill_tools=("validate_content_facts", "query_kb", "open_kb_document", "find_kb_document"),
        config_version=2,
    ),
    ContentAgentSpec(
        ...
        skill_tools=("get_business_facts", "create_content_cover_job"),
        config_version=2,
    ),
)
