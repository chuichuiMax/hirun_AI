...
export const contentApi = {
  ...
  getInspireBrowserSession: () => apiGet('/api/content/inspire/browser-session'),
  heartbeatInspireBrowserSession: () => apiPost('/api/content/inspire/browser-session/heartbeat'),
  claimInspireBrowserSession: () => apiPost('/api/content/inspire/browser-session/claim'),
  actInspireBrowserSession: (payload) => apiPost('/api/content/inspire/browser-session/action', payload),
  getInspireBrowserScreenshot: () =>
    apiGet('/api/content/inspire/browser-session/screenshot', {}, true, 'blob'),
  closeInspireBrowserSession: () => apiDelete('/api/content/inspire/browser-session'),
  bindInspireReference: (taskId, snapshotId) => apiPost(`/api/content/tasks/${taskId}/reference`, { snapshot_id: snapshotId }),
  ...
  getHyCanvasTemplatePreview: (templateId) =>
    apiGet(
      `/api/content/covers/hycanvas/templates/${encodeURIComponent(templateId)}/render.png`,
      {},
      true,
      'blob'
    ),
