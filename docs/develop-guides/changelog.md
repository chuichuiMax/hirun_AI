...
- 好评笔记与装修家居生产分流：好评笔记是业主第一人称评价设计师、预算师、项目经理、客户经理等项目成员，简报要求模仿「好评知识库」已有文章，内容目标只用品牌/教育、禁止获客转化；审批通过后跳过封面规划、提交、等待、视觉审核和人工选封面，直接保存无封面资产。装修家居仍走获客链路和封面等待。小程序好评笔记提交后直接开跑，失败自动重试且不展示失败页，最终审批自动通过。所在区域可选地级市或区县，例如「长沙市」或「长沙市芙蓉区」。
